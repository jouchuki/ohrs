//! Base system prompt template embedded at compile time.

/// The built-in base system prompt; no environment info attached yet.
pub const BASE_SYSTEM_PROMPT: &str = "\
You are ohrs (OpenHarness), an open-source AI coding assistant CLI. \
